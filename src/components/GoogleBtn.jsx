...
class GoogleBtn extends Component {
    ...
    sresponseGoogle = (response)=>{
        if(response.accessToken !== undefined){
            ...
            axios.post("https://reqres.in/api/register",{"email":response.profileObj.email,"password":response.profileObj.googleId}).then((response)=>{
            ...
            alert("Error: email->"+response.profileObj.email+" password->"+response.profileObj.googleId);
        });
        }
    }
